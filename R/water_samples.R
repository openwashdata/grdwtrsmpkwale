#' Samples collected in March and June 2016
#'
#' @format A tibble with 157 rows and 80 variables
#'
#' \describe{
#'   \item{localization}{Name of the localization where the sample was taken.}
#'   \item{geology}{Composition of the ground.}
#'   \item{utm_x}{Geospatial data of the water sampling locations. The geographic coordinate system 'Arc 1960 / UTM zone 37S' (EPSG:21037) which is used for the areas of Kenya and Tanzania - south of equator and east of 36°E.}
#'   \item{utm_y}{Geospatial data of the water sampling locations. The geographic coordinate system 'Arc 1960 / UTM zone 37S' (EPSG:21037) which is used for the areas of Kenya and Tanzania - south of equator and east of 36°E.}
...
#'   \item{NH4}{Ammonium concentration in (mg/L).}
...
#'   \item{delta_O_18}{The ratio of stable isotopes oxygen-18 (18O) and oxygen-16 (16O) as a measure of groundwater/mineral interactions.}
#'   \item{delta_H_2}{δ2H, or delta deuterium, is a measure of the relative abundance of deuterium (a stable isotope of hydrogen) in a sample, often used in hydrology and environmental science to trace the origin and movement of water.}
#'   }
